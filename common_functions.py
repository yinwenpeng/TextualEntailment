...
#         conv_with_bias = T.tanh(conv_out + self.b.dimshuffle('x', 0, 'x', 'x'))
        narrow_conv_out=conv_out.reshape((image_shape[0], filter_shape[0], image_shape[3]-filter_shape[3]+1, image_shape[3]-filter_shape[3]+1)) #(batch, hidden, len, len)
                # pool each feature map individually, using maxpooling
#         pooled_out = pool.pool_2d(
#             input=narrow_conv_out,
#             ds=(2,2),
#             ignore_border=True
#         )
        self.narrow_conv_out=narrow_conv_out#T.tanh(pooled_out + self.b.dimshuffle('x', 0, 'x', 'x'))
